...
|--------|---------|--------|--------|----------|--------|----------|
| 1 | MasterETL | Success | 50 | 45 | 5 | 8 sec |

### Error Capture
| UNOS_ID | ErrorCode | ErrorDescription |
|---------|-----------|------------------|
| ABCD-12345 | VLD002 | Invalid blood type: 'X+'. Must be ABO/Rh format |
| EFGH-67890 | VLD004 | Date of birth in future: 2030-05-15 |
